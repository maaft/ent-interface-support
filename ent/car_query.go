...
func (cq *CarQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (cq *CarQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (cq *CarQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (cq *CarQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (cq *CarQuery) IDs(ctx context.Context) ([]pulid.ID, error) {
	var ids []pulid.ID
...
func (cq *CarQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
