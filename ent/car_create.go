...
func (cc *CarCreate) SetDescription(s string) *CarCreate {
	cc.mutation.SetDescription(s)
	return cc
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (cc *CarCreate) SetNillableDescription(s *string) *CarCreate {
	if s != nil {
		cc.SetDescription(*s)
	}
	return cc
...
func (cc *CarCreate) SetWheelPressure(f float64) *CarCreate {
	cc.mutation.SetWheelPressure(f)
	return cc
}

// SetID sets the "id" field.
func (cc *CarCreate) SetID(pu pulid.ID) *CarCreate {
	cc.mutation.SetID(pu)
	return cc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (cc *CarCreate) SetNillableID(pu *pulid.ID) *CarCreate {
	if pu != nil {
		cc.SetID(*pu)
	}
	return cc
...
func (cc *CarCreate) check() error {
	if _, ok := cc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "Car.createdAt"`)}
	}
	if _, ok := cc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "Car.updatedAt"`)}
	}
	if _, ok := cc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "Car.name"`)}
	}
	if _, ok := cc.mutation.WheelPressure(); !ok {
		return &ValidationError{Name: "wheelPressure", err: errors.New(`ent: missing required field "Car.wheelPressure"`)}
	}
	return nil
}
...
func (cc *CarCreate) createSpec() (*Car, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.WheelPressure(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: car.FieldWheelPressure,
		})
		_node.WheelPressure = value
	}
	return _node, _spec
}
